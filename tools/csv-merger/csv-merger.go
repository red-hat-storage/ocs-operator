				...
				Containers: []corev1.Container{
					...
					},
					{
						...
						Args: []string{"-provider=openshift",
							...
							`-openshift-delegate-urls={"/":{"group":"ocs.openshift.io","resource":"storageclusters","namespace":"openshift-storage","verb":"create"},"/auth/*":{"group":"authorization.k8s.io","resource":"selfsubjectaccessreviews","verb":"create"}}`,
