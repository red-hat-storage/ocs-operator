...
require (
	...
	github.com/noobaa/noobaa-operator/v5 v5.0.0-20240812110642-794c91f1fd62
	...
	github.com/red-hat-storage/ocs-client-operator v0.0.0-20240821062006-7d5b2395f3f8
