...
const (
	...
	StorageClusterPeerRemoteStateInitializing StorageClusterPeerState = "Initializing"
	// StorageClusterPeerRemoteStatePeering represents Peering state of storageClusterPeer
	StorageClusterPeerRemoteStatePeering StorageClusterPeerState = "Peering"
	// StorageClusterPeerRemoteStatePeered represents Peered state of storageClusterPeer
	StorageClusterPeerRemoteStatePeered StorageClusterPeerState = "Peered"
)
...
type StorageClusterPeerStatus struct {
	...
	RemoteStorageClusterUID string                  `json:"remoteStorageClusterUID,omitempty"`
}
