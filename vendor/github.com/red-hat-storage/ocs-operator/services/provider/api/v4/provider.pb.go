...
// KubeObjectReconcilePolicy lists all of the possible actions the client should take whenever it
// process a KubeObject message
type KubeObjectReconcilePolicy int32

const (
	// CreateOnly instructs the client to create the resources using the desired state encoded in the message.
	// The resource will not get updated if it already exists
	KubeObjectReconcilePolicy_CreateOnly KubeObjectReconcilePolicy = 0
	// UpdateOnly instructs the client to update an existing kube object if its actual state differs from the
	// desired state encoded in the message. The kube object will not get created if it does not already
	// exists
	KubeObjectReconcilePolicy_UpdateOnly KubeObjectReconcilePolicy = 1
	// CreateOrUpdate instructs the client to create the kube object if it does not exists, or update it if
	// its state differs from the state encoded in provided message
	KubeObjectReconcilePolicy_CreateOrUpdate KubeObjectReconcilePolicy = 2
)

// Enum value maps for KubeObjectReconcilePolicy.
var (
	KubeObjectReconcilePolicy_name = map[int32]string{
		0: "CreateOnly",
		1: "UpdateOnly",
		2: "CreateOrUpdate",
	}
	KubeObjectReconcilePolicy_value = map[string]int32{
		"CreateOnly":     0,
		"UpdateOnly":     1,
		"CreateOrUpdate": 2,
	}
...
func (x KubeObjectReconcilePolicy) Enum() *KubeObjectReconcilePolicy {
	p := new(KubeObjectReconcilePolicy)
	*p = x
	return p
}

func (x KubeObjectReconcilePolicy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (KubeObjectReconcilePolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_provider_proto_enumTypes[0].Descriptor()
}

func (KubeObjectReconcilePolicy) Type() protoreflect.EnumType {
	return &file_provider_proto_enumTypes[0]
}

func (x KubeObjectReconcilePolicy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use KubeObjectReconcilePolicy.Descriptor instead.
func (KubeObjectReconcilePolicy) EnumDescriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{0}
}

// KubeObjectUpdateStrartegy lists the possible strategy the client is expected to follow when there is a need to
// update a kube object
type KubeObjectUpdateStrategy int32

const (
	// Update expects the client to use k8s update operator to update the kube object. If the update is not allowed
	// (as in the case of an immutable field) no further action will be taken. ResourceVersion conflicts will
	// be honored.
	KubeObjectUpdateStrategy_Update KubeObjectUpdateStrategy = 0
	// Patch expects the client to use k8s patch operator to update the kube object. If the patch is not allowed
	// (as in the case of an immutable field) no further action will be taken. ResourceVersion conflicts will
	// be ignored.
	KubeObjectUpdateStrategy_Patch KubeObjectUpdateStrategy = 1
	// Replace expects the client to delete the existing kube object and replace it with a new kube object created
	// from the desired state
	KubeObjectUpdateStrategy_Replace KubeObjectUpdateStrategy = 2
	// UpdateWithReplaceAsFallback behave similar to Update, but if the update is not allowed (as in the case of
	// an immutable field) the client is expected to fallback to Replace behavior
	KubeObjectUpdateStrategy_UpdateWithReplaceAsFallback KubeObjectUpdateStrategy = 3
)

// Enum value maps for KubeObjectUpdateStrategy.
var (
	KubeObjectUpdateStrategy_name = map[int32]string{
		0: "Update",
		1: "Patch",
		2: "Replace",
		3: "UpdateWithReplaceAsFallback",
	}
	KubeObjectUpdateStrategy_value = map[string]int32{
		"Update":                      0,
		"Patch":                       1,
		"Replace":                     2,
		"UpdateWithReplaceAsFallback": 3,
	}
)

func (x KubeObjectUpdateStrategy) Enum() *KubeObjectUpdateStrategy {
	p := new(KubeObjectUpdateStrategy)
	*p = x
	return p
}

func (x KubeObjectUpdateStrategy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (KubeObjectUpdateStrategy) Descriptor() protoreflect.EnumDescriptor {
	return file_provider_proto_enumTypes[1].Descriptor()
}

func (KubeObjectUpdateStrategy) Type() protoreflect.EnumType {
	return &file_provider_proto_enumTypes[1]
}

func (x KubeObjectUpdateStrategy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use KubeObjectUpdateStrategy.Descriptor instead.
func (KubeObjectUpdateStrategy) EnumDescriptor() ([]byte, []int) {
...
type KubeObject struct {
	...
	// KubeObjectReconcilePolicy describes the actin the client should and should not
	// take to reconcile a kube object
	ReconcilePolicy KubeObjectReconcilePolicy `protobuf:"varint,2,opt,name=reconcilePolicy,proto3,enum=provider.KubeObjectReconcilePolicy" json:"reconcilePolicy,omitempty"`
	// KubeObjectUpdateStrategy describes the means the client should take to update
	// an existing instance of a kube object
	UpdateStrategy KubeObjectUpdateStrategy `protobuf:"varint,3,opt,name=updateStrategy,proto3,enum=provider.KubeObjectUpdateStrategy" json:"updateStrategy,omitempty"`
}
...
func (x *KubeObject) GetReconcilePolicy() KubeObjectReconcilePolicy {
	if x != nil {
		return x.ReconcilePolicy
	}
	return KubeObjectReconcilePolicy_CreateOnly
}

func (x *KubeObject) GetUpdateStrategy() KubeObjectUpdateStrategy {
	if x != nil {
		return x.UpdateStrategy
	}
	return KubeObjectUpdateStrategy_Update
}
...
var file_provider_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x63, 0x65, 0x22, 0xad, 0x03, 0x0a, 0x13, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x74,
	...
	,
	...
	0x69, 0x65, 0x6e, 0x74, 0x49, 0x44, 0x73, 0x22, 0x74, 0x0a, 0x0a, 0x43, 0x6c, 0x69, 0x65, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x24, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x76, 0x6f, 0x6b,
	...
	0x0c, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1d, 0x2e,
	...
	0x0a, 0x12, 0x50, 0x65, 0x65, 0x72, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x43, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x12, 0x23, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x2e,
	0x50, 0x65, 0x65, 0x72, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x43, 0x6c, 0x75, 0x73, 0x74,
	0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x70, 0x72, 0x6f, 0x76,
	...
	0x00, 0x12, 0x6d, 0x0a, 0x16, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4d, 0x61, 0x69, 0x6e,
	0x74, 0x65, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x27, 0x2e, 0x70, 0x72,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x28, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x2e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4d, 0x61, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x61, 0x6e,
	...
	0x69, 0x65, 0x6e, 0x74, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x23, 0x2e, 0x70, 0x72, 0x6f, 0x76,
	0x69, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x43, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x24,
	0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x58, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f,
	0x63, 0x6b, 0x50, 0x6f, 0x6f, 0x6c, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1f, 0x2e, 0x70, 0x72,
	...
	0x6c, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
	0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x70,
...
var file_provider_proto_goTypes = []interface{}{
	(KubeObjectReconcilePolicy)(0),              // 0: provider.KubeObjectReconcilePolicy
	(KubeObjectUpdateStrategy)(0),               // 1: provider.KubeObjectUpdateStrategy
	(ErrorCode)(0),                              // 2: provider.ErrorCode
	(FulfillStorageClaimRequest_StorageType)(0), // 3: provider.FulfillStorageClaimRequest.StorageType
	...
	(*StorageConfigRequest)(nil),                // 6: provider.StorageConfigRequest
	(*GetDesiredClientStateRequest)(nil),        // 7: provider.GetDesiredClientStateRequest
	(*ExternalResource)(nil),                    // 8: provider.ExternalResource
	(*SystemAttributes)(nil),                    // 9: provider.SystemAttributes
	(*StorageConfigResponse)(nil),               // 10: provider.StorageConfigResponse
	(*KubeObject)(nil),                          // 11: provider.KubeObject
	(*GetDesiredClientStateResponse)(nil),       // 12: provider.GetDesiredClientStateResponse
	(*OffboardConsumerRequest)(nil),             // 13: provider.OffboardConsumerRequest
	(*OffboardConsumerResponse)(nil),            // 14: provider.OffboardConsumerResponse
	(*AcknowledgeOnboardingRequest)(nil),        // 15: provider.AcknowledgeOnboardingRequest
	(*AcknowledgeOnboardingResponse)(nil),       // 16: provider.AcknowledgeOnboardingResponse
	(*FulfillStorageClaimRequest)(nil),          // 17: provider.FulfillStorageClaimRequest
	(*FulfillStorageClaimResponse)(nil),         // 18: provider.FulfillStorageClaimResponse
	(*RevokeStorageClaimRequest)(nil),           // 19: provider.RevokeStorageClaimRequest
	(*RevokeStorageClaimResponse)(nil),          // 20: provider.RevokeStorageClaimResponse
	(*StorageClaimConfigRequest)(nil),           // 21: provider.StorageClaimConfigRequest
	(*StorageClaimConfigResponse)(nil),          // 22: provider.StorageClaimConfigResponse
	(*ReportStatusRequest)(nil),                 // 23: provider.ReportStatusRequest
	(*ReportStatusResponse)(nil),                // 24: provider.ReportStatusResponse
	(*PeerStorageClusterRequest)(nil),           // 25: provider.PeerStorageClusterRequest
	(*PeerStorageClusterResponse)(nil),          // 26: provider.PeerStorageClusterResponse
	(*RequestMaintenanceModeRequest)(nil),       // 27: provider.RequestMaintenanceModeRequest
	(*RequestMaintenanceModeResponse)(nil),      // 28: provider.RequestMaintenanceModeResponse
	(*StorageClientsInfoRequest)(nil),           // 29: provider.StorageClientsInfoRequest
	(*ClientInfo)(nil),                          // 30: provider.ClientInfo
	(*StorageClientInfoError)(nil),              // 31: provider.StorageClientInfoError
	(*StorageClientsInfoResponse)(nil),          // 32: provider.StorageClientsInfoResponse
	(*BlockPoolsInfoRequest)(nil),               // 33: provider.BlockPoolsInfoRequest
	(*BlockPoolInfoError)(nil),                  // 34: provider.BlockPoolInfoError
	(*BlockPoolInfo)(nil),                       // 35: provider.BlockPoolInfo
	(*BlockPoolsInfoResponse)(nil),              // 36: provider.BlockPoolsInfoResponse
	nil,                                         // 37: provider.ExternalResource.LabelsEntry
	nil,                                         // 38: provider.ExternalResource.AnnotationsEntry
}
var file_provider_proto_depIdxs = []int32{
	37, // 0: provider.ExternalResource.Labels:type_name -> provider.ExternalResource.LabelsEntry
	38, // 1: provider.ExternalResource.Annotations:type_name -> provider.ExternalResource.AnnotationsEntry
	8,  // 2: provider.StorageConfigResponse.externalResource:type_name -> provider.ExternalResource
	9,  // 3: provider.StorageConfigResponse.systemAttributes:type_name -> provider.SystemAttributes
	0,  // 4: provider.KubeObject.reconcilePolicy:type_name -> provider.KubeObjectReconcilePolicy
	1,  // 5: provider.KubeObject.updateStrategy:type_name -> provider.KubeObjectUpdateStrategy
	11, // 6: provider.GetDesiredClientStateResponse.kubeObjects:type_name -> provider.KubeObject
	3,  // 7: provider.FulfillStorageClaimRequest.storageType:type_name -> provider.FulfillStorageClaimRequest.StorageType
	8,  // 8: provider.StorageClaimConfigResponse.externalResource:type_name -> provider.ExternalResource
	2,  // 9: provider.StorageClientInfoError.code:type_name -> provider.ErrorCode
	30, // 10: provider.StorageClientsInfoResponse.clientsInfo:type_name -> provider.ClientInfo
	31, // 11: provider.StorageClientsInfoResponse.errors:type_name -> provider.StorageClientInfoError
	2,  // 12: provider.BlockPoolInfoError.code:type_name -> provider.ErrorCode
	35, // 13: provider.BlockPoolsInfoResponse.blockPoolsInfo:type_name -> provider.BlockPoolInfo
	34, // 14: provider.BlockPoolsInfoResponse.errors:type_name -> provider.BlockPoolInfoError
	4,  // 15: provider.OCSProvider.OnboardConsumer:input_type -> provider.OnboardConsumerRequest
	6,  // 16: provider.OCSProvider.GetStorageConfig:input_type -> provider.StorageConfigRequest
	7,  // 17: provider.OCSProvider.GetDesiredClientState:input_type -> provider.GetDesiredClientStateRequest
	13, // 18: provider.OCSProvider.OffboardConsumer:input_type -> provider.OffboardConsumerRequest
	15, // 19: provider.OCSProvider.AcknowledgeOnboarding:input_type -> provider.AcknowledgeOnboardingRequest
	17, // 20: provider.OCSProvider.FulfillStorageClaim:input_type -> provider.FulfillStorageClaimRequest
	19, // 21: provider.OCSProvider.RevokeStorageClaim:input_type -> provider.RevokeStorageClaimRequest
	21, // 22: provider.OCSProvider.GetStorageClaimConfig:input_type -> provider.StorageClaimConfigRequest
	23, // 23: provider.OCSProvider.ReportStatus:input_type -> provider.ReportStatusRequest
	25, // 24: provider.OCSProvider.PeerStorageCluster:input_type -> provider.PeerStorageClusterRequest
	27, // 25: provider.OCSProvider.RequestMaintenanceMode:input_type -> provider.RequestMaintenanceModeRequest
	29, // 26: provider.OCSProvider.GetStorageClientsInfo:input_type -> provider.StorageClientsInfoRequest
	33, // 27: provider.OCSProvider.GetBlockPoolsInfo:input_type -> provider.BlockPoolsInfoRequest
	5,  // 28: provider.OCSProvider.OnboardConsumer:output_type -> provider.OnboardConsumerResponse
	10, // 29: provider.OCSProvider.GetStorageConfig:output_type -> provider.StorageConfigResponse
	12, // 30: provider.OCSProvider.GetDesiredClientState:output_type -> provider.GetDesiredClientStateResponse
	14, // 31: provider.OCSProvider.OffboardConsumer:output_type -> provider.OffboardConsumerResponse
	16, // 32: provider.OCSProvider.AcknowledgeOnboarding:output_type -> provider.AcknowledgeOnboardingResponse
	18, // 33: provider.OCSProvider.FulfillStorageClaim:output_type -> provider.FulfillStorageClaimResponse
	20, // 34: provider.OCSProvider.RevokeStorageClaim:output_type -> provider.RevokeStorageClaimResponse
	22, // 35: provider.OCSProvider.GetStorageClaimConfig:output_type -> provider.StorageClaimConfigResponse
	24, // 36: provider.OCSProvider.ReportStatus:output_type -> provider.ReportStatusResponse
	26, // 37: provider.OCSProvider.PeerStorageCluster:output_type -> provider.PeerStorageClusterResponse
	28, // 38: provider.OCSProvider.RequestMaintenanceMode:output_type -> provider.RequestMaintenanceModeResponse
	32, // 39: provider.OCSProvider.GetStorageClientsInfo:output_type -> provider.StorageClientsInfoResponse
	36, // 40: provider.OCSProvider.GetBlockPoolsInfo:output_type -> provider.BlockPoolsInfoResponse
