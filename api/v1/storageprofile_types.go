...
// +kubebuilder:validation:XValidation:rule="!has(oldSelf.name) || has(self.name)", message="name is required once set"
...
const (
	SPReconcileFailed           = "ReconcileFailed"
	SPReconcileInit             = "Init"
	SPReconcileCompleted        = "ReconcileCompleted"
	SPReconcileCompletedMessage = "Reconcile completed successfully"
)
