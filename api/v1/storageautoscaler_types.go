...
// +kubebuilder:printcolumn:name="LastRunStartTimeStamp",type=date,JSONPath=.status.lastExpansion.startTime,description="Last Run Start Time Stamp"
// +kubebuilder:printcolumn:name="LastRunCompletionTimeStamp",type=date,JSONPath=.status.lastExpansion.completionTime,description="Last Run Completion Time Stamp"
