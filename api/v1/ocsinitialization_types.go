...
type OCSInitializationSpec struct {
	...
	// Foo is an example field of OCSInitialization. Edit OCSInitialization_types.go to remove/update
...
// OCSInitialization is the Schema for the ocsinitializations API
