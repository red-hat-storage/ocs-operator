...
type StorageClusterSpec struct {
	...
	// +kubebuilder:deprecatedversion:warning="AllowRemoteStorageConsumers field has been deprecated and will be ignored within the reconcile. It will be removed in the future."
