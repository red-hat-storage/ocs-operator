...
type ManageCephFilesystems struct {
	...
	// +kubebuilder:validation:XValidation:message="defaultStorageClassDataPoolName is immutable",rule="self.defaultStorageClassDataPoolName == oldSelf.defaultStorageClassDataPoolName"
