...
// Old Ceph error conditions must be cleared once Ceph has recovered.
// Noobaa may still report Progressing during this time.
// Phase must move from Error to Progressing.
