...
type ClientInfo struct {
	...
	ClientProfile  map[string]string `protobuf:"bytes,4,rep,name=clientProfile,proto3" json:"clientProfile,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *ClientInfo) GetClientProfile() map[string]string {
	if x != nil {
...
var file_provider_proto_rawDesc = []byte{
	...
	0x85, 0x02, 0x0a, 0x0a, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1a,
	...
	0x72, 0x61, 0x67, 0x65, 0x49, 0x44, 0x12, 0x4d, 0x0a, 0x0d, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e,
	0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49,
	0x6e, 0x66, 0x6f, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c,
	0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0d, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x50, 0x72,
	0x6f, 0x66, 0x69, 0x6c, 0x65, 0x1a, 0x40, 0x0a, 0x12, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x50,
...
var file_provider_proto_goTypes = []interface{}{
	...
	nil,                                         // 36: provider.ClientInfo.ClientProfileEntry
}
var file_provider_proto_depIdxs = []int32{
	...
	36, // 6: provider.ClientInfo.clientProfile:type_name -> provider.ClientInfo.ClientProfileEntry
	0,  // 7: provider.StorageClientInfoError.code:type_name -> provider.ErrorCode
	27, // 8: provider.StorageClientsInfoResponse.clientsInfo:type_name -> provider.ClientInfo
	28, // 9: provider.StorageClientsInfoResponse.errors:type_name -> provider.StorageClientInfoError
	0,  // 10: provider.BlockPoolInfoError.code:type_name -> provider.ErrorCode
	32, // 11: provider.BlockPoolsInfoResponse.blockPoolsInfo:type_name -> provider.BlockPoolInfo
	31, // 12: provider.BlockPoolsInfoResponse.errors:type_name -> provider.BlockPoolInfoError
	2,  // 13: provider.OCSProvider.OnboardConsumer:input_type -> provider.OnboardConsumerRequest
	4,  // 14: provider.OCSProvider.GetStorageConfig:input_type -> provider.StorageConfigRequest
	5,  // 15: provider.OCSProvider.GetDesiredClientState:input_type -> provider.GetDesiredClientStateRequest
	10, // 16: provider.OCSProvider.OffboardConsumer:input_type -> provider.OffboardConsumerRequest
	12, // 17: provider.OCSProvider.AcknowledgeOnboarding:input_type -> provider.AcknowledgeOnboardingRequest
	14, // 18: provider.OCSProvider.FulfillStorageClaim:input_type -> provider.FulfillStorageClaimRequest
	16, // 19: provider.OCSProvider.RevokeStorageClaim:input_type -> provider.RevokeStorageClaimRequest
	18, // 20: provider.OCSProvider.GetStorageClaimConfig:input_type -> provider.StorageClaimConfigRequest
	20, // 21: provider.OCSProvider.ReportStatus:input_type -> provider.ReportStatusRequest
	22, // 22: provider.OCSProvider.PeerStorageCluster:input_type -> provider.PeerStorageClusterRequest
	24, // 23: provider.OCSProvider.RequestMaintenanceMode:input_type -> provider.RequestMaintenanceModeRequest
	26, // 24: provider.OCSProvider.GetStorageClientsInfo:input_type -> provider.StorageClientsInfoRequest
	30, // 25: provider.OCSProvider.GetBlockPoolsInfo:input_type -> provider.BlockPoolsInfoRequest
	3,  // 26: provider.OCSProvider.OnboardConsumer:output_type -> provider.OnboardConsumerResponse
	8,  // 27: provider.OCSProvider.GetStorageConfig:output_type -> provider.StorageConfigResponse
	9,  // 28: provider.OCSProvider.GetDesiredClientState:output_type -> provider.GetDesiredClientStateResponse
	11, // 29: provider.OCSProvider.OffboardConsumer:output_type -> provider.OffboardConsumerResponse
	13, // 30: provider.OCSProvider.AcknowledgeOnboarding:output_type -> provider.AcknowledgeOnboardingResponse
	15, // 31: provider.OCSProvider.FulfillStorageClaim:output_type -> provider.FulfillStorageClaimResponse
	17, // 32: provider.OCSProvider.RevokeStorageClaim:output_type -> provider.RevokeStorageClaimResponse
	19, // 33: provider.OCSProvider.GetStorageClaimConfig:output_type -> provider.StorageClaimConfigResponse
	21, // 34: provider.OCSProvider.ReportStatus:output_type -> provider.ReportStatusResponse
	23, // 35: provider.OCSProvider.PeerStorageCluster:output_type -> provider.PeerStorageClusterResponse
	25, // 36: provider.OCSProvider.RequestMaintenanceMode:output_type -> provider.RequestMaintenanceModeResponse
	29, // 37: provider.OCSProvider.GetStorageClientsInfo:output_type -> provider.StorageClientsInfoResponse
	33, // 38: provider.OCSProvider.GetBlockPoolsInfo:output_type -> provider.BlockPoolsInfoResponse
