...
var file_provider_proto_rawDesc = []byte{
	...
	0x0a, 0x4b, 0x75, 0x62, 0x65, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x42,
	0x79, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x42, 0x79, 0x74, 0x65,
	...
	0x52, 0x09, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x44, 0x73, 0x22, 0x74, 0x0a, 0x0a, 0x43,
	...
	0x44, 0x22, 0x77, 0x0a, 0x16, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x43, 0x6c, 0x69, 0x65,
...
var file_provider_proto_depIdxs = []int32{
	...
	28, // 8: provider.StorageClientsInfoResponse.clientsInfo:type_name -> provider.ClientInfo
	29, // 9: provider.StorageClientsInfoResponse.errors:type_name -> provider.StorageClientInfoError
	0,  // 10: provider.BlockPoolInfoError.code:type_name -> provider.ErrorCode
	33, // 11: provider.BlockPoolsInfoResponse.blockPoolsInfo:type_name -> provider.BlockPoolInfo
	32, // 12: provider.BlockPoolsInfoResponse.errors:type_name -> provider.BlockPoolInfoError
	...
	11, // 16: provider.OCSProvider.OffboardConsumer:input_type -> provider.OffboardConsumerRequest
	13, // 17: provider.OCSProvider.AcknowledgeOnboarding:input_type -> provider.AcknowledgeOnboardingRequest
	15, // 18: provider.OCSProvider.FulfillStorageClaim:input_type -> provider.FulfillStorageClaimRequest
	17, // 19: provider.OCSProvider.RevokeStorageClaim:input_type -> provider.RevokeStorageClaimRequest
	19, // 20: provider.OCSProvider.GetStorageClaimConfig:input_type -> provider.StorageClaimConfigRequest
	21, // 21: provider.OCSProvider.ReportStatus:input_type -> provider.ReportStatusRequest
	23, // 22: provider.OCSProvider.PeerStorageCluster:input_type -> provider.PeerStorageClusterRequest
	25, // 23: provider.OCSProvider.RequestMaintenanceMode:input_type -> provider.RequestMaintenanceModeRequest
	27, // 24: provider.OCSProvider.GetStorageClientsInfo:input_type -> provider.StorageClientsInfoRequest
	31, // 25: provider.OCSProvider.GetBlockPoolsInfo:input_type -> provider.BlockPoolsInfoRequest
	...
	10, // 28: provider.OCSProvider.GetDesiredClientState:output_type -> provider.GetDesiredClientStateResponse
