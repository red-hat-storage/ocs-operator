...
var file_provider_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xd9, 0x07, 0x0a, 0x0b, 0x4f,
...
var file_provider_proto_goTypes = []interface{}{
	...
	(*SystemAttributes)(nil),                    // 5: provider.SystemAttributes
	(*StorageConfigResponse)(nil),               // 6: provider.StorageConfigResponse
	...
	(*AcknowledgeOnboardingRequest)(nil),        // 9: provider.AcknowledgeOnboardingRequest
	(*AcknowledgeOnboardingResponse)(nil),       // 10: provider.AcknowledgeOnboardingResponse
	(*FulfillStorageClaimRequest)(nil),          // 11: provider.FulfillStorageClaimRequest
	(*FulfillStorageClaimResponse)(nil),         // 12: provider.FulfillStorageClaimResponse
	(*RevokeStorageClaimRequest)(nil),           // 13: provider.RevokeStorageClaimRequest
	(*RevokeStorageClaimResponse)(nil),          // 14: provider.RevokeStorageClaimResponse
	(*StorageClaimConfigRequest)(nil),           // 15: provider.StorageClaimConfigRequest
	(*StorageClaimConfigResponse)(nil),          // 16: provider.StorageClaimConfigResponse
	(*ReportStatusRequest)(nil),                 // 17: provider.ReportStatusRequest
	(*ReportStatusResponse)(nil),                // 18: provider.ReportStatusResponse
	(*PeerStorageClusterRequest)(nil),           // 19: provider.PeerStorageClusterRequest
	(*PeerStorageClusterResponse)(nil),          // 20: provider.PeerStorageClusterResponse
	(*RequestMaintenanceModeRequest)(nil),       // 21: provider.RequestMaintenanceModeRequest
	(*RequestMaintenanceModeResponse)(nil),      // 22: provider.RequestMaintenanceModeResponse
...
var file_provider_proto_depIdxs = []int32{
	...
	5,  // 3: provider.StorageConfigResponse.systemAttributes:type_name -> provider.SystemAttributes
	0,  // 4: provider.FulfillStorageClaimRequest.storageType:type_name -> provider.FulfillStorageClaimRequest.StorageType
	4,  // 5: provider.StorageClaimConfigResponse.externalResource:type_name -> provider.ExternalResource
	...
	9,  // 9: provider.OCSProvider.AcknowledgeOnboarding:input_type -> provider.AcknowledgeOnboardingRequest
	11, // 10: provider.OCSProvider.FulfillStorageClaim:input_type -> provider.FulfillStorageClaimRequest
	13, // 11: provider.OCSProvider.RevokeStorageClaim:input_type -> provider.RevokeStorageClaimRequest
	15, // 12: provider.OCSProvider.GetStorageClaimConfig:input_type -> provider.StorageClaimConfigRequest
	17, // 13: provider.OCSProvider.ReportStatus:input_type -> provider.ReportStatusRequest
	19, // 14: provider.OCSProvider.PeerStorageCluster:input_type -> provider.PeerStorageClusterRequest
	21, // 15: provider.OCSProvider.RequestMaintenanceMode:input_type -> provider.RequestMaintenanceModeRequest
	2,  // 16: provider.OCSProvider.OnboardConsumer:output_type -> provider.OnboardConsumerResponse
	6,  // 17: provider.OCSProvider.GetStorageConfig:output_type -> provider.StorageConfigResponse
	8,  // 18: provider.OCSProvider.OffboardConsumer:output_type -> provider.OffboardConsumerResponse
	10, // 19: provider.OCSProvider.AcknowledgeOnboarding:output_type -> provider.AcknowledgeOnboardingResponse
	12, // 20: provider.OCSProvider.FulfillStorageClaim:output_type -> provider.FulfillStorageClaimResponse
	14, // 21: provider.OCSProvider.RevokeStorageClaim:output_type -> provider.RevokeStorageClaimResponse
	16, // 22: provider.OCSProvider.GetStorageClaimConfig:output_type -> provider.StorageClaimConfigResponse
	18, // 23: provider.OCSProvider.ReportStatus:output_type -> provider.ReportStatusResponse
	20, // 24: provider.OCSProvider.PeerStorageCluster:output_type -> provider.PeerStorageClusterResponse
	22, // 25: provider.OCSProvider.RequestMaintenanceMode:output_type -> provider.RequestMaintenanceModeResponse
