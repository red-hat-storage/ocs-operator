...
type OCSProviderClient interface {
	...
	// GetStorageInfo RPC call to generate the json config for connecting to storage provider cluster
	GetStorageInfo(ctx context.Context, in *StorageConfigRequest, opts ...grpc.CallOption) (*StorageConfigResponse, error)
...
func (c *oCSProviderClient) GetStorageInfo(ctx context.Context, in *StorageConfigRequest, opts ...grpc.CallOption) (*StorageConfigResponse, error) {
	out := new(StorageConfigResponse)
	err := c.cc.Invoke(ctx, "/provider.OCSProvider/GetStorageInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OCSProviderServer interface {
	...
	// GetStorageInfo RPC call to generate the json config for connecting to storage provider cluster
	GetStorageInfo(context.Context, *StorageConfigRequest) (*StorageConfigResponse, error)
	// OffboardConsumer RPC call to delete StorageConsumer CR on the storage provider cluster.
...
func (UnimplementedOCSProviderServer) GetStorageInfo(context.Context, *StorageConfigRequest) (*StorageConfigResponse, error) {
...
func _OCSProvider_GetStorageInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StorageConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OCSProviderServer).GetStorageInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/provider.OCSProvider/GetStorageInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OCSProviderServer).GetStorageInfo(ctx, req.(*StorageConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OCSProvider_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OCSProvider_GetStorageInfo_Handler,
		},
		{
