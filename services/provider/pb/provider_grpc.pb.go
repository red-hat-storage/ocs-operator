...
type OCSProviderClient interface {
	...
	// OnboardStorageClusterPeer RPC call to onboard the StorageClusterPeer to the remote ODF Cluster
	...
	// OffboardStorageClusterPeer RPC call to offboard the StorageClusterPeer from the remote ODF Cluster
	...
	// GetMirroringInfo RPC call to get the mirroring info for connecting block pools from local to remote ODF Cluster
