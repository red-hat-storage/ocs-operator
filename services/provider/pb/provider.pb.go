...
type OnboardMirroringPeerRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	OnboardingTicket string `protobuf:"bytes,1,opt,name=onboardingTicket,proto3" json:"onboardingTicket,omitempty"`
	// storageClusterPeerName is the name of the storageClusterPeer representation on the provider
	StorageClusterPeerName string `protobuf:"bytes,2,opt,name=storageClusterPeerName,proto3" json:"storageClusterPeerName,omitempty"`
}

func (x *OnboardMirroringPeerRequest) Reset() {
	*x = OnboardMirroringPeerRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *OnboardMirroringPeerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnboardMirroringPeerRequest) ProtoMessage() {}

func (x *OnboardMirroringPeerRequest) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnboardMirroringPeerRequest.ProtoReflect.Descriptor instead.
func (*OnboardMirroringPeerRequest) Descriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{17}
}

func (x *OnboardMirroringPeerRequest) GetOnboardingTicket() string {
	if x != nil {
		return x.OnboardingTicket
	}
	return ""
...
func (x *OnboardMirroringPeerRequest) GetStorageClusterPeerName() string {
	if x != nil {
		return x.StorageClusterPeerName
	}
	return ""
}

// OnboardMirroringPeerResponse holds the response for OnboardMirroringPeer API request
type OnboardMirroringPeerResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// UUID is the K8s UID (UUID) of the MirroringPeer representation on the provider cluster
	UUID string `protobuf:"bytes,1,opt,name=UUID,proto3" json:"UUID,omitempty"`
}

func (x *OnboardMirroringPeerResponse) Reset() {
	*x = OnboardMirroringPeerResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *OnboardMirroringPeerResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnboardMirroringPeerResponse) ProtoMessage() {}

func (x *OnboardMirroringPeerResponse) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnboardMirroringPeerResponse.ProtoReflect.Descriptor instead.
func (*OnboardMirroringPeerResponse) Descriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{18}
}

func (x *OnboardMirroringPeerResponse) GetUUID() string {
	if x != nil {
		return x.UUID
	}
	return ""
...
// OffboardMirroringPeerRequest holds the required information offboard MirroringPeer on the Storage Provider cluster.
type OffboardMirroringPeerRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *OffboardMirroringPeerRequest) Reset() {
	*x = OffboardMirroringPeerRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *OffboardMirroringPeerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OffboardMirroringPeerRequest) ProtoMessage() {}

func (x *OffboardMirroringPeerRequest) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OffboardMirroringPeerRequest.ProtoReflect.Descriptor instead.
func (*OffboardMirroringPeerRequest) Descriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{19}
}

func (x *OffboardMirroringPeerRequest) GetUUID() string {
	if x != nil {
		return x.UUID
	}
	return ""
...
// OffboardMirroringPeerResponse holds the response for the OffboardMirroringPeer API request
type OffboardMirroringPeerResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *OffboardMirroringPeerResponse) Reset() {
	*x = OffboardMirroringPeerResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *OffboardMirroringPeerResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OffboardMirroringPeerResponse) ProtoMessage() {}

func (x *OffboardMirroringPeerResponse) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OffboardMirroringPeerResponse.ProtoReflect.Descriptor instead.
func (*OffboardMirroringPeerResponse) Descriptor() ([]byte, []int) {
...
type AcknowledgeMirrorPeerOnboardingRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AcknowledgeMirrorPeerOnboardingRequest) Reset() {
	*x = AcknowledgeMirrorPeerOnboardingRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *AcknowledgeMirrorPeerOnboardingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AcknowledgeMirrorPeerOnboardingRequest) ProtoMessage() {}

func (x *AcknowledgeMirrorPeerOnboardingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AcknowledgeMirrorPeerOnboardingRequest.ProtoReflect.Descriptor instead.
func (*AcknowledgeMirrorPeerOnboardingRequest) Descriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{21}
}

func (x *AcknowledgeMirrorPeerOnboardingRequest) GetUUID() string {
	if x != nil {
		return x.UUID
	}
	return ""
...
// AcknowledgeMirrorPeerOnboardingResponse holds the response for the AcknowledgeMirrorPeerOnboarding API request
type AcknowledgeMirrorPeerOnboardingResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *AcknowledgeMirrorPeerOnboardingResponse) Reset() {
	*x = AcknowledgeMirrorPeerOnboardingResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *AcknowledgeMirrorPeerOnboardingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AcknowledgeMirrorPeerOnboardingResponse) ProtoMessage() {}

func (x *AcknowledgeMirrorPeerOnboardingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AcknowledgeMirrorPeerOnboardingResponse.ProtoReflect.Descriptor instead.
func (*AcknowledgeMirrorPeerOnboardingResponse) Descriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{22}
}

// MirroringInfoRequest holds the information required to get config for connecting block pools on storage provider cluster.
...
func (x *MirroringInfoRequest) GetUUID() string {
	if x != nil {
		return x.UUID
	}
	return ""
...
var file_provider_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x32, 0xbe, 0x09, 0x0a, 0x0b, 0x4f, 0x43, 0x53, 0x50, 0x72,
	...
	,
...
var file_provider_proto_goTypes = []interface{}{
	...
	(*OnboardMirroringPeerRequest)(nil),             // 18: provider.OnboardMirroringPeerRequest
	(*OnboardMirroringPeerResponse)(nil),            // 19: provider.OnboardMirroringPeerResponse
	(*OffboardMirroringPeerRequest)(nil),            // 20: provider.OffboardMirroringPeerRequest
	(*OffboardMirroringPeerResponse)(nil),           // 21: provider.OffboardMirroringPeerResponse
	(*AcknowledgeMirrorPeerOnboardingRequest)(nil),  // 22: provider.AcknowledgeMirrorPeerOnboardingRequest
	(*AcknowledgeMirrorPeerOnboardingResponse)(nil), // 23: provider.AcknowledgeMirrorPeerOnboardingResponse
...
var file_provider_proto_depIdxs = []int32{
	...
	18, // 12: provider.OCSProvider.OnboardMirroringPeer:input_type -> provider.OnboardMirroringPeerRequest
	20, // 13: provider.OCSProvider.OffboardMirroringPeer:input_type -> provider.OffboardMirroringPeerRequest
	22, // 14: provider.OCSProvider.AcknowledgeMirrorPeerOnboarding:input_type -> provider.AcknowledgeMirrorPeerOnboardingRequest
	...
	19, // 24: provider.OCSProvider.OnboardMirroringPeer:output_type -> provider.OnboardMirroringPeerResponse
	21, // 25: provider.OCSProvider.OffboardMirroringPeer:output_type -> provider.OffboardMirroringPeerResponse
	23, // 26: provider.OCSProvider.AcknowledgeMirrorPeerOnboarding:output_type -> provider.AcknowledgeMirrorPeerOnboardingResponse
...
func file_provider_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_provider_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OnboardMirroringPeerRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provider_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OnboardMirroringPeerResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provider_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OffboardMirroringPeerRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provider_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OffboardMirroringPeerResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provider_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AcknowledgeMirrorPeerOnboardingRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provider_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AcknowledgeMirrorPeerOnboardingResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
