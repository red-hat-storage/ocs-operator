...
type PeerBlockPoolRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PeerBlockPoolRequest) Reset() {
...
func (x *PeerBlockPoolRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PeerBlockPoolRequest) ProtoMessage() {}

func (x *PeerBlockPoolRequest) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PeerBlockPoolRequest.ProtoReflect.Descriptor instead.
func (*PeerBlockPoolRequest) Descriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{17}
}

func (x *PeerBlockPoolRequest) GetSecretName() string {
	if x != nil {
		return x.SecretName
	}
	return ""
...
func (x *PeerBlockPoolRequest) GetPool() []byte {
	if x != nil {
		return x.Pool
	}
	return nil
...
func (x *PeerBlockPoolRequest) GetToken() []byte {
	if x != nil {
		return x.Token
	}
	return nil
...
type PeerBlockPoolResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *PeerBlockPoolResponse) Reset() {
	*x = PeerBlockPoolResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PeerBlockPoolResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PeerBlockPoolResponse) ProtoMessage() {}

func (x *PeerBlockPoolResponse) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PeerBlockPoolResponse.ProtoReflect.Descriptor instead.
func (*PeerBlockPoolResponse) Descriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{18}
}

type RevokeBlockPoolPeeringRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RevokeBlockPoolPeeringRequest) Reset() {
	*x = RevokeBlockPoolPeeringRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *RevokeBlockPoolPeeringRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RevokeBlockPoolPeeringRequest) ProtoMessage() {}

func (x *RevokeBlockPoolPeeringRequest) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RevokeBlockPoolPeeringRequest.ProtoReflect.Descriptor instead.
func (*RevokeBlockPoolPeeringRequest) Descriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{19}
}

func (x *RevokeBlockPoolPeeringRequest) GetSecretName() string {
	if x != nil {
		return x.SecretName
	}
	return ""
...
func (x *RevokeBlockPoolPeeringRequest) GetPool() []byte {
	if x != nil {
		return x.Pool
	}
	return nil
...
type RevokeBlockPoolPeeringResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *RevokeBlockPoolPeeringResponse) Reset() {
	*x = RevokeBlockPoolPeeringResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *RevokeBlockPoolPeeringResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RevokeBlockPoolPeeringResponse) ProtoMessage() {}

func (x *RevokeBlockPoolPeeringResponse) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RevokeBlockPoolPeeringResponse.ProtoReflect.Descriptor instead.
func (*RevokeBlockPoolPeeringResponse) Descriptor() ([]byte, []int) {
...
var file_provider_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x22, 0x60,
	0x0a, 0x14, 0x50, 0x65, 0x65, 0x72, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x50, 0x6f, 0x6f, 0x6c, 0x52,
	...
	,
	...
	,
...
var file_provider_proto_goTypes = []interface{}{
	...
	(*PeerBlockPoolRequest)(nil),                     // 18: provider.PeerBlockPoolRequest
	(*PeerBlockPoolResponse)(nil),                    // 19: provider.PeerBlockPoolResponse
	(*RevokeBlockPoolPeeringRequest)(nil),            // 20: provider.RevokeBlockPoolPeeringRequest
	(*RevokeBlockPoolPeeringResponse)(nil),           // 21: provider.RevokeBlockPoolPeeringResponse
}
var file_provider_proto_depIdxs = []int32{
	...
	18, // 11: provider.OCSProvider.PeerBlockPool:input_type -> provider.PeerBlockPoolRequest
	20, // 12: provider.OCSProvider.RevokeBlockPoolPeering:input_type -> provider.RevokeBlockPoolPeeringRequest
	...
	11, // 17: provider.OCSProvider.FulfillStorageClassClaim:output_type -> provider.FulfillStorageClassClaimResponse
	13, // 18: provider.OCSProvider.RevokeStorageClassClaim:output_type -> provider.RevokeStorageClassClaimResponse
	15, // 19: provider.OCSProvider.GetStorageClassClaimConfig:output_type -> provider.StorageClassClaimConfigResponse
	17, // 20: provider.OCSProvider.ReportStatus:output_type -> provider.ReportStatusResponse
	19, // 21: provider.OCSProvider.PeerBlockPool:output_type -> provider.PeerBlockPoolResponse
	21, // 22: provider.OCSProvider.RevokeBlockPoolPeering:output_type -> provider.RevokeBlockPoolPeeringResponse
...
func file_provider_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_provider_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PeerBlockPoolRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provider_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PeerBlockPoolResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provider_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RevokeBlockPoolPeeringRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provider_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RevokeBlockPoolPeeringResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
