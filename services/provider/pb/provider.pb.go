...
// StorageClientRequest holds the information required generate the json config for connecting to storage provider cluster
type StorageClientRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StorageClientRequest) Reset() {
	*x = StorageClientRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *StorageClientRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StorageClientRequest) ProtoMessage() {}

func (x *StorageClientRequest) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StorageClientRequest.ProtoReflect.Descriptor instead.
func (*StorageClientRequest) Descriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{2}
}

func (x *StorageClientRequest) GetStorageConsumerUUID() string {
	if x != nil {
		return x.StorageConsumerUUID
	}
	return ""
...
// StorageConfigResponse holds the response for the GetStorageClientConfig API request
type StorageClientResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// StorageQuotaInGiBHash holds the hash of StorageQuotaInGiB
	StorageQuotaInGiBHash string `protobuf:"bytes,1,opt,name=StorageQuotaInGiBHash,proto3" json:"StorageQuotaInGiBHash,omitempty"`
}

func (x *StorageClientResponse) Reset() {
	*x = StorageClientResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *StorageClientResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StorageClientResponse) ProtoMessage() {}

func (x *StorageClientResponse) ProtoReflect() protoreflect.Message {
	mi := &file_provider_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StorageClientResponse.ProtoReflect.Descriptor instead.
func (*StorageClientResponse) Descriptor() ([]byte, []int) {
	return file_provider_proto_rawDescGZIP(), []int{4}
}

func (x *StorageClientResponse) GetStorageQuotaInGiBHash() string {
	if x != nil {
		return x.StorageQuotaInGiBHash
	}
	return ""
}
...
var file_provider_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x44, 0x61, 0x74, 0x61, 0x22, 0x4d, 0x0a, 0x15, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x43,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a,
	0x15, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x51, 0x75, 0x6f, 0x74, 0x61, 0x49, 0x6e, 0x47,
	0x69, 0x42, 0x48, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x15, 0x53, 0x74,
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x51, 0x75, 0x6f, 0x74, 0x61, 0x49, 0x6e, 0x47, 0x69, 0x42, 0x48,
	0x61, 0x73, 0x68, 0x22, 0x4b, 0x0a, 0x17, 0x4f, 0x66, 0x66, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x43,
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x93, 0x02, 0x0a, 0x13, 0x52, 0x65, 0x70, 0x6f,
	...
	0x09, 0x52, 0x0a, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x5a, 0x0a,
	0x14, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x42, 0x0a, 0x1c, 0x64, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64,
	0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x43, 0x68,
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x1c, 0x64, 0x65, 0x73,
	0x69, 0x72, 0x65, 0x64, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74,
	0x6f, 0x72, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x32, 0x8d, 0x06, 0x0a, 0x0b, 0x4f, 0x43,
	...
	0x65, 0x22, 0x00, 0x12, 0x5b, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1e, 0x2e,
	0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
	0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e,
	0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
...
var file_provider_proto_goTypes = []interface{}{
	...
	(*StorageClientRequest)(nil),                // 3: provider.StorageClientRequest
	(*ExternalResource)(nil),                    // 4: provider.ExternalResource
	(*StorageClientResponse)(nil),               // 5: provider.StorageClientResponse
...
var file_provider_proto_depIdxs = []int32{
	0,  // 0: provider.FulfillStorageClaimRequest.storageType:type_name -> provider.FulfillStorageClaimRequest.StorageType
	4,  // 1: provider.StorageClaimConfigResponse.externalResource:type_name -> provider.ExternalResource
	1,  // 2: provider.OCSProvider.OnboardConsumer:input_type -> provider.OnboardConsumerRequest
	3,  // 3: provider.OCSProvider.GetStorageClientConfig:input_type -> provider.StorageClientRequest
	6,  // 4: provider.OCSProvider.OffboardConsumer:input_type -> provider.OffboardConsumerRequest
	8,  // 5: provider.OCSProvider.AcknowledgeOnboarding:input_type -> provider.AcknowledgeOnboardingRequest
	10, // 6: provider.OCSProvider.FulfillStorageClaim:input_type -> provider.FulfillStorageClaimRequest
	12, // 7: provider.OCSProvider.RevokeStorageClaim:input_type -> provider.RevokeStorageClaimRequest
	14, // 8: provider.OCSProvider.GetStorageClaimConfig:input_type -> provider.StorageClaimConfigRequest
	16, // 9: provider.OCSProvider.ReportStatus:input_type -> provider.ReportStatusRequest
	2,  // 10: provider.OCSProvider.OnboardConsumer:output_type -> provider.OnboardConsumerResponse
	5,  // 11: provider.OCSProvider.GetStorageClientConfig:output_type -> provider.StorageClientResponse
	7,  // 12: provider.OCSProvider.OffboardConsumer:output_type -> provider.OffboardConsumerResponse
	9,  // 13: provider.OCSProvider.AcknowledgeOnboarding:output_type -> provider.AcknowledgeOnboardingResponse
	11, // 14: provider.OCSProvider.FulfillStorageClaim:output_type -> provider.FulfillStorageClaimResponse
	13, // 15: provider.OCSProvider.RevokeStorageClaim:output_type -> provider.RevokeStorageClaimResponse
	15, // 16: provider.OCSProvider.GetStorageClaimConfig:output_type -> provider.StorageClaimConfigResponse
	17, // 17: provider.OCSProvider.ReportStatus:output_type -> provider.ReportStatusResponse
...
func file_provider_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_provider_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StorageClientRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_provider_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StorageClientResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
