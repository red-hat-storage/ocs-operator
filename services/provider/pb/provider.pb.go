...
var file_provider_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xdb, 0x06, 0x0a, 0x0b, 0x4f, 0x43, 0x53, 0x50, 0x72,
...
var file_provider_proto_depIdxs = []int32{
	...
	11, // 16: provider.OCSProvider.FulfillStorageClaim:output_type -> provider.FulfillStorageClaimResponse
	13, // 17: provider.OCSProvider.RevokeStorageClaim:output_type -> provider.RevokeStorageClaimResponse
	15, // 18: provider.OCSProvider.GetStorageClaimConfig:output_type -> provider.StorageClaimConfigResponse
