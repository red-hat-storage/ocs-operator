...
func mockGetStorageConfig(mockError common.MockError) (*pb.StorageClientResponse, error) { //nolint:deadcode,unused
	switch mockError {
	...
	return &pb.StorageClientResponse{
		StorageQuotaInGiBHash: "testHash",
	}, nil
}
