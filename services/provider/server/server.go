	...
	if consumerConfig.GetRbdClientProfileName() != "" {
		scMap[util.GenerateNameForCephBlockPoolStorageClass(storageCluster)] = func() *storagev1.StorageClass {
			return util.NewDefaultRbdStorageClass(
				...
				util.GetPoolName(storageCluster.Spec.ManagedResources.CephBlockPools, storageCluster.Name),
				...
				util.GetDataPoolName(storageCluster.Spec.ManagedResources.CephBlockPools, storageCluster.Name),
			)
		}
