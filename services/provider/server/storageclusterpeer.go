...
func (s *storageClusterPeerManager) FindStorageClusterPeerWithStorageClusterID(ctx context.Context, storageClusterUID types.UID) (*ocsv1.StorageClusterPeer, error) {
