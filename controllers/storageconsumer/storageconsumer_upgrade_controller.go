...
func (r *StorageConsumerUpgradeReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	clientOperatorVersionPredicate := predicate.TypedFuncs[ocsv1alpha1.StorageConsumer]{
		CreateFunc: func(e event.TypedCreateEvent[ocsv1alpha1.StorageConsumer]) bool {
			return strings.HasPrefix(e.Object.Status.Client.OperatorVersion, "4.18")
		},
		DeleteFunc: func(e event.TypedDeleteEvent[ocsv1alpha1.StorageConsumer]) bool {
			return false
		},
		UpdateFunc: func(e event.TypedUpdateEvent[ocsv1alpha1.StorageConsumer]) bool {
			return false
		},
		GenericFunc: func(e event.TypedGenericEvent[ocsv1alpha1.StorageConsumer]) bool {
			return false
		},
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ocsv1alpha1.StorageConsumer{}, builder.WithPredicates(clientOperatorVersionPredicate)).
		Complete(r)
}
...
func (r *StorageConsumerUpgradeReconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	log := log.FromContext(ctx, "StorageConsumerUpgrade", request.NamespacedName)
