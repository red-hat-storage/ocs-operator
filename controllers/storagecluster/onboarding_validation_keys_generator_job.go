...
func (o *onboardingValidationKeysGeneratorJob) createJob(r *StorageClusterReconciler, instance *ocsv1.StorageCluster) (reconcile.Result, error) {
	var err error
	r.Log.Info("Spec.AllowRemoteStorageConsumers is enabled. test ritesh Creating Onboarding validation key generator job")
	...
	publicKeySecret.Namespace = instance.Namespace
