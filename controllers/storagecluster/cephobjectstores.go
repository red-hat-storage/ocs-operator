...
func (obj *ocsCephObjectStores) ensureCreated(r *StorageClusterReconciler, instance *ocsv1.StorageCluster) (reconcile.Result, error) {
	...
	// ie, sc.Spec.Encryption.ClusterWide/sc.Spec.Encryption.Enable is True or any deviceSet is encrypted
	// and KMS ConfigMap is available
	if instance.Spec.Encryption.Enable || instance.Spec.Encryption.ClusterWide || util.IsAnyDeviceSetEncrypted(instance.Spec.StorageDeviceSets) {
