...
func TestGetValueAtPath(t *testing.T) {
	cases := []struct {
		...
		{
			name: "cephBlockPools poolSpec deviceClass explicitly set to empty string",
			unstructuredSC: &unstructured.Unstructured{
				Object: map[string]interface{}{
					"apiVersion": "ocs.openshift.io/v1",
					"kind":       "StorageCluster",
			...
			path:          []string{"spec", "managedResources", "cephBlockPools", "poolSpec", "deviceClass"},
			expectedValue: "",
			expectedFound: true,
		},
		{
		...
		{
			name: "cephObjectStores dataPoolSpec deviceClass not specified",
			unstructuredSC: &unstructured.Unstructured{
				Object: map[string]interface{}{
					"spec": map[string]interface{}{
						"managedResources": map[string]interface{}{
			...
			path:          []string{"spec", "managedResources", "cephObjectStores", "dataPoolSpec", "deviceClass"},
			expectedValue: nil,
			expectedFound: false,
		},

		// StorageDeviceSets array access
		{
