...
var deviceClassPlacementKey = "device-class"
...
func newStorageClassDeviceSets(sc *ocsv1.StorageCluster) []rookCephv1.StorageClassDeviceSet {
	...
	for _, ds := range storageDeviceSets {
		...
		for i := range replica {
			...
			placement.TopologySpreadConstraints[0].LabelSelector = placement.TopologySpreadConstraints[0].LabelSelector.DeepCopy()
			...
			preparePlacement.TopologySpreadConstraints[0].LabelSelector = preparePlacement.TopologySpreadConstraints[0].LabelSelector.DeepCopy()
