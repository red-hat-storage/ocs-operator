...
export DEVICEFINDER_IMAGE=${DEVICEFINDER_IMAGE:-${DEVICEFINDER_FULL_IMAGE_NAME}}
export BLACKBOX_EXPORTER_IMAGE=${BLACKBOX_EXPORTER_IMAGE:-${LATEST_BLACKBOX_EXPORTER_IMAGE}}
export KUBE_RBAC_PROXY_IMAGE=${KUBE_RBAC_PROXY_IMAGE:-${KUBE_RBAC_PROXY_FULL_IMAGE_NAME}}
...
echo -e "\tDEVICEFINDER_IMAGE=$DEVICEFINDER_IMAGE"
echo -e "\tBLACKBOX_EXPORTER_IMAGE=$BLACKBOX_EXPORTER_IMAGE"
echo -e "\tKUBE_RBAC_PROXY_IMAGE=$KUBE_RBAC_PROXY_IMAGE"
