...
UPGRADE_FROM_OCS_REGISTRY_IMAGE="${UPGRADE_FROM_OCS_REGISTRY_IMAGE:-}"
UPGRADE_FROM_LOCAL_STORAGE_REGISTRY_NAME="${UPGRADE_FROM_LOCAL_STORAGE_REGISTRY_NAME:-$default_local_storage_image}"
