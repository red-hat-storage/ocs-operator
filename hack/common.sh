...
if [ -n "$OPENSHIFT_BUILD_NAMESPACE" ]; then
	BUNDLE_FULL_IMAGE_NAME="registry.svc.ci.openshift.org/${OPENSHIFT_BUILD_NAMESPACE}/stable:${OPERATOR_BUNDLE_NAME}"
	INDEX_FULL_IMAGE_NAME="registry.svc.ci.openshift.org/${OPENSHIFT_BUILD_NAMESPACE}/stable:${OPERATOR_INDEX_NAME}"
	echo "Openshift CI detected, deploying using image $BUNDLE_FULL_IMAGE_NAME and $INDEX_FULL_IMAGE_NAME"
