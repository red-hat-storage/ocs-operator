...
DEFAULT_OPERATOR_CATALOG_NAME="ocs-operator-catalog"
...
OPERATOR_CATALOG_NAME="${OPERATOR_CATALOG_NAME:-${DEFAULT_OPERATOR_CATALOG_NAME}}"
...
DEFAULT_CATALOG_FULL_IMAGE_NAME="${IMAGE_REGISTRY}/${REGISTRY_NAMESPACE}/${OPERATOR_CATALOG_NAME}:${IMAGE_TAG}"
...
DEFAULT_NOOBAA_BUNDLE_TAG="master-20220916"
