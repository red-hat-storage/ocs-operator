...
LATEST_ROOK_IMAGE="docker.io/rook/ceph:v1.10.0"
LATEST_NOOBAA_IMAGE="${DEFAULT_NOOBAA_BUNDLE_REGISTRY}/noobaa-operator:${DEFAULT_NOOBAA_BUNDLE_TAG}"
LATEST_NOOBAA_CORE_IMAGE="noobaa/noobaa-core:${DEFAULT_NOOBAA_BUNDLE_TAG}"
