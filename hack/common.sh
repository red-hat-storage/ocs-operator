...
DEVICEFINDER_IMAGE_NAME="${DEVICEFINDER_IMAGE_NAME:=ocs-devicefinder}"
...
DEVICEFINDER_FULL_IMAGE_NAME="${DEVICEFINDER_FULL_IMAGE_NAME:=${IMAGE_REGISTRY}/${REGISTRY_NAMESPACE}/${DEVICEFINDER_IMAGE_NAME}:${IMAGE_TAG}}"
