...
UPGRADE_VERSION_IMAGE_REGISTRY ?= $(IMAGE_REGISTRY)
UPGRADE_VERSION_REGISTRY_NAMESPACE ?= $(REGISTRY_NAMESPACE)
UPGRADE_VERSION_IMAGE_TAG ?= $(IMAGE_TAG)
...
upgrade-test: cluster-clean
	@echo "Upgrading ocs to a newer version"
	REGISTRY_NAMESPACE=$(REGISTRY_NAMESPACE) IMAGE_TAG=$(IMAGE_TAG) IMAGE_REGISTRY=$(IMAGE_REGISTRY) \
	UPGRADE_VERSION_REGISTRY_NAMESPACE=$(UPGRADE_VERSION_REGISTRY_NAMESPACE) UPGRADE_VERSION_IMAGE_TAG=$(UPGRADE_VERSION_IMAGE_TAG) \
	UPGRADE_VERSION_IMAGE_REGISTRY=$(UPGRADE_VERSION_IMAGE_REGISTRY) \
	UPGRADE_VERSION_SUBSCRIBE_CHANNEL=$(UPGRADE_VERSION_SUBSCRIBE_CHANNEL) \
